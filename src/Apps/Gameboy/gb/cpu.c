...
static inline unsigned short get_word_ticked(unsigned short i)
{
	unsigned short word;
...
static inline void write_word_ticked(unsigned short d, unsigned short i)
{
...
static inline void RLC(unsigned char reg)
{
	unsigned char t, old;
...
static inline void RRC(unsigned char reg)
{
	unsigned char t, old;
...
static inline void RL(unsigned char reg)
{
	unsigned char t, t2;
...
static inline void RR(unsigned char reg)
{
	unsigned char t, t2;
...
static inline void SLA(unsigned char reg)
{
	unsigned char t;
...
static inline void SRA(unsigned char reg)
{
	unsigned char old, t;
...
static inline void SRL(unsigned char reg)
{
	unsigned char t;
...
static inline void SWAP(unsigned char reg)
{
	unsigned char t;
...
static inline void BIT(unsigned char bit, unsigned char reg)
{
...
static inline void RES(unsigned char bit, unsigned char reg)
{
	unsigned char t;
...
static inline void SET(unsigned char bit, unsigned char reg)
{
	unsigned char t;
...
*/
static inline void decode_CB(unsigned char t)
{
...
static int inline cpu_cycle(void)
{
	unsigned char b, t;
	unsigned short s;
	unsigned int i;
